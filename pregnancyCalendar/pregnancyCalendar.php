    ...
    echo "
        <div class='app' id='app'>
            ...
            <div class='content'>
                <div class='main'>
                    <div class='main__text'>
                        ...
                        <div class='results' v-if='showOvulation'>
                            ...
                            <p class='text text-justify'>
                            <p class='text text-justify'>
                                Vous êtes féconde entre le <span> {{  fecondDate  }} </span> <br>
                            </p>
                            </p>
                        </div>
                        ...
                        <div class='results' v-if='showMore'>
                            ...
                            <p class='text text-justify'>
                                Votre bébé n'est plus prématuré à partir du: <span>{{ prematureDate }}</span> <br>
                                Date limite pour effectuer le test de trisomie 21: entre le <span>{{ dateTriso1 }} </span>
                                et le
                                <span>{{ dateTriso2 }}</span> <br>
                                La consultation avec l'anesthésiste est à effectuer à partir du
                                <span>{{ anesthDate }}</span> <br>
                                Le prélèvement vaginal est à éffectuer entre le <span>{{ dateVagA }}</span> et le
                                <span>{{ dateVagB }}</span> <br>
                            </p>
                        </div>
                ...
                <div class='item' id='more' v-if='results != null'>
                    <h2>
                        Plus
                    </h2>
